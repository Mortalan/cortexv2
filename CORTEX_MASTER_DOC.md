...
### ACTIVE TASKS
- [ ] Phase 14: AI-Driven Behavioral Triage Activation (n8n + VIKI).
- [ ] Phase 14.1: Final Hardening Audit of the 192.168.50.X subnet.
...
- [x] **Ingress Stability:** Resolved Authelia protocol mismatch and wildcard DNS resolution.
- [x] **Internal DNS Fix:** Updated local hosts to bypass NAT Loopback issues for 192.168.50.239.
- [x] **GLPI Setup:** Successfully initialized ticketing system and secured the install directory.
- [x] **NetLock RMM Recovery:** Swapped to MariaDB 10.11 for x86-64-v2 compatibility and restored configuration.
