...
8. **SPIDER Ingress Permissions & Gateway Switches (Mole Run - June 8, 2026):** Added SPIDER to `staticServicesData` and default user configuration switches, enabling the configuration and control of its ingress gateway access via the user permissions control panel.
